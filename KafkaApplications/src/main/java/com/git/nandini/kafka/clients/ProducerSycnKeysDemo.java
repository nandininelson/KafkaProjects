...
public class ProducerSycnKeysDemo {
    public static void main(String args[]) {

        Logger logger = LoggerFactory.getLogger(ProducerSycnKeysDemo.class);
        ...
        try {
            for (int i = 0; i < 10; i++) {
                //sends data synchronously with Keys - sync only for testing
                // We will observe on re-running the programs; keys go to the same partition
